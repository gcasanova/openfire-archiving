package com.i7.openfire.archive.util;
...
/**
 * Utility class to parse and format dates in UTC that adhere to the DateTime
 * format specified in Jabber Date and Time Profiles.
 */
